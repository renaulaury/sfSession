...
CREATE TABLE IF NOT EXISTS `category` (
  ...
  `libelle_category` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `intern` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name_intern` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Listage des données de la table sfsessionlily.intern : ~0 rows (environ)
DELETE FROM `intern`;
...
CREATE TABLE IF NOT EXISTS `module` (
  ...
  `libelle_module` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `session` (
  ...
  `libelle_session` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
DELETE FROM `session_intern`;

-- Listage de la structure de table sfsessionlily. trainer
CREATE TABLE IF NOT EXISTS `trainer` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name_trainer` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `firstname` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `training` (
  `id` int NOT NULL AUTO_INCREMENT,
  `libelle_training` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DELETE FROM `user`;
INSERT INTO `user` (`id`, `nickname`, `email`, `roles`, `password`) VALUES
	(2, 'Lisou', 'lisou@gmail.com', '[]', '1234');
